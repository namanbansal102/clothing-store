  ...
  console.log("outlet in Client Side is:::::::::::::::::::::::::::::::::::::::::", (outlet['outlet'])['url']);
    const fetchData = async () => {
        try {
          ...
          const response = await fetch(`${process.env.NEXT_PUBLIC_HOST}api/fetchProdWomen`, {
            method: 'POST',
            headers: {
      ...
      const fetchSimilarProducts=async (params)=>{
        const response = await fetch(`${process.env.NEXT_PUBLIC_HOST}api/getSimilarProductsWomen`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
